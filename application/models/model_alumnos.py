...
def insert_alumnos(nom_alum,telefono_alum,telefono_tutor,direccion):
    try:
        return db.insert('alumnos',nom_alum=nom_alum,
...
def edit_alumnos(id_alumno,nom_alum,telefono_alum,telefono_tutor,direccion):
    try:
